...
(function ($) {
  ...
  var settings = {
    ...
    data: [],
    searchable: true,
    searchNoData: '<li style="color:#ddd">No items matching your search./~~</li>',
    init: noop,
    choice: noop,
    extendProps: []
  };
  ...
  function maxItemAlert() {
    ...
    if ($alert.length === 0) {
      $alert = $('<div class="dropdown-maxItem-alert">You can only select up to ' + _config.limitCount + ' options.</div>');
    }
