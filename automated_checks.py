...
Select(find_element_medium('banner', 'linkcategory')).select_by_value('Donate Landing')
...
Select(marketing_obj).select_by_value('Donation')
taxonomy_code.send_keys('123456')
Select(find_element_medium('video', 'source')).select_by_value('Channel 4')
Select(find_element_medium('video', 'linkcategory')).select_by_value('Donate Landing')
...
Select(find_element_medium('audio', 'linkcategory')).select_by_value('Donate Landing')
...
Select(marketing_obj).select_by_value('Donation')
taxonomy_code.send_keys('123456')
find_element_medium('socialad', 'source').send_keys('Facebook')
time.sleep(1)
find_element_medium('socialad', 'linkcategory').send_keys('Donate - Other')
...
find_element_medium('socialad', 'source').send_keys('Instagram')
find_element_medium('socialad', 'linkcategory').send_keys('Get Help')
...
find_element_medium('socialad', 'source').send_keys('LinkedIn')
find_element_medium('socialad', 'linkcategory').send_keys('About Us')
...
find_element_medium('socialad', 'source').send_keys('Twitter')
find_element_medium('socialad', 'linkcategory').send_keys('Navigation')
urls = final_url.get_attribute('value')
url_list = [i for i in urls.split('\n') if i!='']
outputs['socialad'] += url_list

find_element_medium('socialad', 'source').send_keys('TikTok')
find_element_medium('socialad', 'linkcategory').send_keys('Get Involved')
...
find_element_medium('socialpost', 'linkcategory').send_keys('First Aid')
...
find_element_medium('socialshare', 'linkcategory').send_keys('Get Involved')
...
time.sleep(1)
find_element_medium('socialbutton', 'linkcategory').send_keys('Shop')
url = final_url.get_attribute('value')
...
Select(marketing_obj).select_by_value('Donation')
taxonomy_code.send_keys('123456')
find_element_medium('email', 'source').send_keys('Salesforce')
time.sleep(1)
...
find_element_medium('email', 'source').send_keys('DotDigital')
time.sleep(1)
...
find_element_medium('email', 'source').send_keys('Hubspot')
time.sleep(1)
...
time.sleep(1)
Select(find_element_medium('internal', 'linkcategory')).select_by_value('Webapps')
...
time.sleep(1)
Select(find_element_medium('offline', 'linkcategory')).select_by_value('Donate Landing')
...
Select(find_element_medium('rocketseed', 'linkcategory')).select_by_value('Donate Landing')
...
Select(driver.find_element(By.CSS_SELECTOR, "#isIndividual")).select_by_value('No')
Select(find_element_medium('rocketseed', 'linkcategory')).select_by_value('Get Involved')
